				...
				<div class="fl b_right_menu">
					<ul>
						<li><a href="<%=basePath%>${app.id}/base"
							class="click current " id="reports_tab">统计分析</a>
						</li>
				...
				<div class="b_right_public">
					<div class="conright">
						<div id="main">
							...
							<div class="statsTableHeader">TOP 10 操作系统</div>
							...
							<div style="padding-bottom: 10px;" class="bitemcon" id="ac0">
								...
								<table cellspacing="0" cellpadding="0" border="0"
									...
									<thead>
										<tr class="">
											<th width="120" class="new_silver_first_n" scope="col">操作系统</th>
...
<div class="statsTableHeader">
		...
		<strong>操作系统分布明细</strong>
	</div>
							<script type="text/javascript">
$(document).ready(function() { 
    // call the tablesorter plugin 
    $("#os_sliv_table").tablesorter({
    	sortForce: [[2,2]],
        sortList: [[2,2]]
    });
});
							...
							<div style="margin-bottom: 40px;" class="stats_content"
								...
								<table width="100%" cellspacing="0" border="0" id="os_sliv_table"
									class="new_silver_table">
									<thead>
										<tr>
											<th class="new_silver_first_n" scope="col">操作系统</th>
