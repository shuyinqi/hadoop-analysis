...
<%-- 
<script src="<%=basePath%>statics/js/stat/tree/jquery.js" type="text/javascript"></script>
	<script src="<%=basePath%>statics/js/stat/tree/jquery-ui.custom.js" type="text/javascript"></script>
	<script src="<%=basePath%>statics/js/stat/tree/jquery.cookie.js" type="text/javascript"></script>
