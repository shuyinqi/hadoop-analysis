...
<%@page import="com.mapbar.analyzelog.report.entity.AccessVO"%>
...
<%
	...
	List<AccessVO> list=(List<AccessVO>)request.getAttribute("stats");seriesData.append("[");
	for(int i=0;i<list.size();i++){
		AccessVO vo=list.get(i);
							...
							<div class="ccon">
								...
								<div class="piecright">
									<table cellspacing="0" cellpadding="0" border="0"
										...
										<tbody>
											<tr class="">
												<th width="80" class="new_silver_first_n" scope="col">联网方式</th>
